            ...
            <div className="nine columns main-col">
              {
                resumeData.work1 && resumeData.work1.map((item) => {
                  return(
                    <div className="row item treestones" style={{backgroundImage: 'url("images/treecompanyimage.png")'}}>
                       <div className="twelve columns">
            ...
            <div className="nine columns main-col seconddiv"><br />
              {
                resumeData.work2 && resumeData.work2.map((item) => {
                  return(
                    <div className="row item imaginarycloud" style={{backgroundImage: 'url("images/cloudcompanyimage.png")'}}>
                       <div className="twelve columns">
                          <h3>{item.CompanyName}</h3>
                          <p className="info">
                          {item.specialization}<br /><br />
            ...
            <div className="nine columns main-col"><br />
              {
                resumeData.work3 && resumeData.work3.map((item) => {
                  return(
                    <div className="row item sintrabusiness" style={{backgroundImage: 'url("images/sintracompanyimage.png")'}}>
                       <div className="twelve columns">
                          <h3>{item.CompanyName}</h3>
                          <p className="info">
                          {item.specialization}<br /><br />
